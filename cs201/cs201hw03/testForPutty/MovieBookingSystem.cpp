...
void MovieBookingSystem::addMovie( const long givenMovieID , const int givenAudienceRadius) {
    ...
    if( checkMovieList( givenMovieID ) ){ movie m( givenMovieID , givenAudienceRadius ); movieLinkedList.add(m);}/* checks if there is no movie with given id and adds to the list */
